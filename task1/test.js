...
describe("Fizz Buzz tests", function() {
  ...
  it("should return 47 since its indivisible by 3 and 5", function(){
    expect(myApp.fizzBuzz(47)).to.equal(47);
  });
  it("should return 94 since its indivisible by 3 and 5", function(){
    expect(myApp.fizzBuzz(94)).to.equal(94);
  });
